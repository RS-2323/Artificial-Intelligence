...
def start():
    ...
    def play(button):
        ...
        if (button1["text"] == "X" and button2["text"] == "X" and button3["text"] == "X" or
            ...
            answer = tkinter.messagebox.askquestion('X Player wins!!!', 'X Player wins!!!Do you want to play again')
            ...
            answer = tkinter.messagebox.askquestion('O Player wins!!!', 'O Player wins!!!Do you want to play again')
